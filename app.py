...
line_channel_access_token = 'UUxTfwRJ2j2RafozTdkb+j76juz8Cb2aI1m6Fx4o8xucSW3OaM0t8yx5b1SboJ41DUHPnltURUEnfZa70R8dmlZ+B38g1/qeycmnCrBCEpQ7hBRSGEmUuo7OMB4oVz9yzwZV3XxmW1ZHhhEtK1mmjAdB04t89/1O/w1cDnyilFU='
...
def reply_menu(reply_token):
  ...
  "template": {
    ...
    "columns": [
      ...
      {
        "thumbnailImageUrl": "https://www.webcrayons.com.sg/images/travel-application-devleopment/travel.png",
        "text": "Travel",
        "actions": [
          {
            "type": "message",
